...
int main(int argc, char* argv[])
{
	try
	{
		...
		Rx::LFR::CCalibration xTestCalibration;
		Rx::LFR::CCalibrationManager::LoadDefaultCalibration(xTestCalibration, xCameraTest, true);
		...
		xCudaCompute.ApplyCalibration(xTestCalibration, true);
