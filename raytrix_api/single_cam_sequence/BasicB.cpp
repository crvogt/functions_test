...
int main(int argc, char* argv[])
{
	try
	{
		...
		Rx::CRxString ray_file = "C://Users//cvogt//Desktop//gray_to_png//0034045116//plant.ray";
		Rx::LFR::CRayFileReader::Read(ray_file, xInputImage);
		...
		seq_out.StartWriting(xInputImage.GetFormat(), xInputImage.GetCalibration(), xInputImage.GetMetaData(), doubleShotMode);
