...
int main(int argc, char* argv[])
{
	try
	{
		...
		//Rx::CRxString sxFile = "C:\\Users\\cvogt\\Desktop\\gray_to_png\\plant.ray";
		Rx::CRxString sxFile = "E:\\camera_poses\\straight_1\\1680\\1680_Ray.ray";
		...
		Rx::LFR::CCalibration cal_val = xInputImage.GetCalibration();
		xCudaCompute.ApplyCalibration(xInputImage.GetCalibration(), true);
		
		//Rx::CRxString save_xml = "C:\\Users\\cvogt\\Desktop\\gray_to_png\\save_calib.xml";
		//cal_val.SaveAsXmlFile(save_xml);
