/*
This file should allow us to go from a number of individual
raw images to a LF video

Taking in a folder of raw.png files outputing a single
.rays file (making sure each image has its bayer coding)

refer to rays_from_ray
*/
...
int main(int argc, char* argv[])
{
	try
	{
		...
		for (int i = 0; i < 100; i++) {
			...
			//TODO set this so that it iterates through
