'''
NOT WORKING, DUE TO regularizers
'''



#The sparsity constraint on the activity of the hidden 
#representations so fewer units would "fire" at a given 
#time. In Keras, this is or can be done by adding an
#activity_regularizer to the dense layer

#We'll train this one for 100 epochs
...
encoded = Dense(encoding_dim, activation='relu',
				activity_regularizer=regularizers.l1(0.00001))(input_img)
