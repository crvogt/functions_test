...
z_mean = Dense(1400, name='z_mean')(x)
z_log_var = Dense(1400, name='z_log_var')(x)
...
x = Conv2D(8, (3, 3), activation='relu', padding='same')(decoder_in) # (8, 8)
x = UpSampling2D((2, 2))(x) # (16, 16)
x = Conv2D(16, (3, 3), activation='relu')(x) # (14, 14)
x = UpSampling2D((2, 2))(x) # (28, 28)
decoder_out = Conv2D(3, (3, 3), activation='sigmoid', padding='same')(x) # (100, 100)
