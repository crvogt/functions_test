...
import keras 
from keras.layers import Input, Conv2D, MaxPooling2D, Add, Concatenate
...
print(x.shape)
x = Conv2D(10, (5,5), padding='same', activation='relu')(x)
xb1 = keras.layers.add([x, xa1])

# print("xshape")
# print(x.shape)
# print("xa1shape")
# print(xa1.shape)
# xb1 = keras.layers.Concatenate([extra, x])
# print("xb1 shape:")
# print(xb1.shape)
#x = Conv2D(5, (5,5), padding='same', activation='relu')(x)
decoder_out = Conv2D(3, (5, 5), activation='sigmoid', padding='same')(xb1) 
print('decoder out')
