...
def my_gen():
	...
	while 1:
		...
		bodyImg = bodyImg.resize((w, h), Image.ANTIALIAS)
...
x = Conv2D(10, (3, 3), padding='same', activation='relu')(encoder_in)
print(x.shape)
...
x = MaxPooling2D((2,2))(x)
print(x.shape)
x = Conv2D(35, (3, 3), padding='same', activation='relu')(x)
print(x.shape)
# x = MaxPooling2D((2,2))(x)
print(x.shape)
...
get_model_memory_usage(batchGlob, ae)
