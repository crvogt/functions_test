...
subplot(5,1,5);
subplot(5,1,1)
h(1) = heatmap(tl1,'Gain', 'Shutter_Speed', 'ColorVariable','Var3','ColorLimits',[0 32], 'Colormap',autumn)
title(h(1), 'PSNR at Light Setting 1')
h(1).ColorbarVisible = 'off'
subplot(5,1,2)
h(2) = heatmap(tl2,'Gain', 'Shutter_Speed', 'ColorVariable', 'Var3','ColorLimits',[0 32], 'Colormap',autumn)
title(h(2), 'PSNR at Light Setting 2')
h(2).ColorbarVisible = 'off'
subplot(5,1,3)
h(3) = heatmap(tl3,'Gain', 'Shutter_Speed', 'ColorVariable', 'Var3','ColorLimits',[0 32], 'Colormap',autumn)
title(h(3), 'PSNR at Light Setting 3')
h(3).ColorbarVisible = 'off'
subplot(5,1,4)
h(4) = heatmap(tl4,'Gain', 'Shutter_Speed', 'ColorVariable', 'Var3','ColorLimits',[0 32], 'Colormap',autumn)
title(h(4), 'PSNR at Light Setting 4')
h(4).ColorbarVisible = 'off'
subplot(5,1,5)
h(5) = heatmap(tl5,'Gain', 'Shutter_Speed', 'ColorVariable', 'Var3','ColorLimits',[0 32], 'Colormap',autumn)
