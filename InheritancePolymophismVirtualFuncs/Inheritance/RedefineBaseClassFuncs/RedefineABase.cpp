/*
This program demonstrates a class that 
redefines a base class function
*/
#include <iostream>
#include <iomanip>
...
int main(int argc, char **argv){
	//hold numeric score
	double numericScore;
	//Hold curve percentage
	double percentage;

	//Define CurvedActivity object
	CurvedActivity exam;

	//Get unadjusted score
	...
	cout << "The curved score is "
		 << exam.getScore() << endl;
	cout << "The curved letter grade is "
